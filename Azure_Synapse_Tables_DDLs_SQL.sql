...
select * FROM airbnb.dim_customer;

select * FROM airbnb.fact_booking;
...
https://viinaykumaarmamidi.app.n8n.cloud/workflow/Z8upAPyWgCv6oKeO_vZYU?projectId=x5j1SxtmI4JEJUVM


----

Project : 3: Bookmyshow Realtime data pipeline
